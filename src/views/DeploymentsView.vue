          ...
          <section data-testid="deployment-global-settings" class="deployment-surface overflow-hidden">
            ...
            <div v-if="globalOpen" class="space-y-5 border-t p-4 dark:border-white/10">
              ...
              <div class="grid gap-3 border-t pt-4 sm:grid-cols-2 lg:grid-cols-3 dark:border-white/10">
                ...
                <div class="flex items-center gap-1 self-end py-2"><input id="global-firewall-enabled" v-model="global.firewall.enabled" type="checkbox" /><DeploymentHelpLabel class="text-sm" for-id="global-firewall-enabled" :label="t('deployments.fields.firewall')" :help="t('deployments.help.firewall')" :open="deploymentInfoPopoverKey === generatorHelpKey('firewall')" test-id="firewall-help" @update:open="value => setDeploymentInfoPopover(generatorHelpKey('firewall'), value)" /></div>
              </div>
