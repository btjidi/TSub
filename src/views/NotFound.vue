<template>
  <div class="not-found-container font-sans text-gray-100 dark:text-gray-100">
    ...
    <!-- Content Card -->
    <div class="relative z-10 glass-panel border border-white/10 tsub-radius-lg p-12 max-w-lg w-[90%] text-center shadow-2xl backdrop-blur-xl animate-fade-in-up">
