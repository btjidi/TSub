                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div v-if="loading" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div v-for="i in 6" :key="i"
                            class="h-[300px] bg-white dark:bg-gray-800 tsub-radius-lg p-6 shadow-sm border border-gray-100 dark:border-gray-700 animate-pulse">
                            <div class="flex items-center gap-4 mb-6">
                                <div class="h-12 w-12 bg-gray-200 dark:bg-gray-700 tsub-radius-lg"></div>
                            ...
                            <div class="mt-auto h-12 bg-gray-100 dark:bg-gray-700/50 tsub-radius-lg"></div>
                        </div>
                    </div>

                    <!-- Error State -->
                    <div v-else-if="error" class="text-center py-20 bg-white/50 dark:bg-gray-800/50 tsub-radius-lg border border-red-100 dark:border-red-900/30 backdrop-blur-sm">
                        ...
                        <button @click="fetchPublicProfiles"
                            class="px-6 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-medium tsub-radius-lg shadow-lg shadow-primary-600/20 transition-all active:scale-95">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                            <div v-for="client in clients" :key="client.name"
                                ...
                                <div class="flex items-start gap-5">
                                    <div class="h-12 w-12 tsub-radius-lg flex items-center justify-center text-3xl shadow-sm bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 group-hover:scale-105 transition-transform duration-300 shrink-0 overflow-hidden">
    <img v-if="client.icon && (client.icon.includes('/') || client.icon.startsWith('data:'))" :src="client.icon"
                        ...
                        <span v-else>{{ client.icon }}</span>
                                ...
                                <div class="mt-6 flex items-center justify-between pt-4 border-t border-gray-50 dark:border-white/5">
                                    <span class="text-xs text-gray-400 bg-gray-50 dark:bg-white/5 px-2 py-1 tsub-radius-md">
