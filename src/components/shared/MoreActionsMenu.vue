...
<template>
  <div ref="triggerRef" class="relative shrink-0">
    <button @click="toggleMenu" @keydown="handleTriggerKeydown" :aria-expanded="isOpen" aria-haspopup="menu" :aria-label="t('actions.bulkActions')" :aria-controls="menuId" class="p-2.5 tsub-radius-md hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
    ...
    <Transition name="slide-fade-sm">
      <div
        ...
        :class="['absolute right-0 mt-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm tsub-radius-lg shadow-lg dark:shadow-2xl z-50 ring-1 ring-black/5', menuWidthClass]"
      >
    ...
    <Teleport v-if="teleportToBody" to="body">
      <Transition name="slide-fade-sm">
        <div
          ...
          :id="menuId"
          role="menu"
          :class="['fixed mt-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm tsub-radius-lg shadow-lg dark:shadow-2xl ring-1 ring-black/5', menuWidthClass]"
