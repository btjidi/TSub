...
const sanitizedContent = computed(() => sanitizeHtml(announcement.value.content || '', {
...
<template>
    <div class="space-y-6">
        <!-- 头部说明 -->
        <div
            class="bg-white/90 dark:bg-gray-900/70 tsub-radius-lg p-6 space-y-6 border border-gray-100/80 dark:border-white/10 shadow-sm animate-fade-in-down">
            ...
            <div
                class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-700 tsub-radius-lg">
                <div>
        ...
        <div v-if="announcement.enabled"
            class="bg-white dark:bg-gray-800 tsub-radius-lg p-6 space-y-6 border border-gray-100 dark:border-gray-700 shadow-sm animate-fade-in-down">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" v-model="announcement.title" @input="handleContentUpdate" :placeholder="t('settings.announcementTitlePlaceholder')"
                        class="block w-full px-3 py-2 bg-gray-50 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-600 tsub-radius-lg shadow-xs focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:text-white transition-colors">
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    <textarea v-model="announcement.content" @input="handleContentUpdate" rows="6"
                        ...
                        class="block w-full px-3 py-2 bg-gray-50 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-600 tsub-radius-lg shadow-xs focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:text-white transition-colors font-mono"></textarea>
            ...
            <!-- 预览区域 (可选) -->
            <div
                class="mt-4 p-4 border border-dashed border-gray-300 dark:border-gray-600 tsub-radius-lg bg-gray-50 dark:bg-gray-900/30">
                <h4 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">{{ t('settings.announcementPreview') }}</h4>
                <div class="bg-white dark:bg-gray-800 tsub-radius-md shadow-sm border p-4" :class="{
