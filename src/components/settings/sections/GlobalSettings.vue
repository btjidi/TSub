        ...
        <div>
          ...
          <div class="relative">
            <select
              ...
              class="w-full bg-gray-50 dark:bg-gray-800 border border-transparent dark:border-gray-700 tsub-radius-md py-2.5 px-4 text-xs text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:outline-none transition-all appearance-none"
            >
        ...
        <div>
          ...
          <div class="relative">
            <select
              ...
              class="w-full bg-gray-50 dark:bg-gray-800 border border-transparent dark:border-gray-700 tsub-radius-md py-2 px-4 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:outline-none transition-all appearance-none"
            >
              <option v-for="option in prefixToggleOptions" :key="String(option.value)" :value="option.value">{{ t(option.labelKey) }}</option>
            </select>
            <div class="absolute inset-y-0 right-0 flex items-center px-3 pointer-events-none text-gray-400">
