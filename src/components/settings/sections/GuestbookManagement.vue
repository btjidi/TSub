...
<template>
    <div class="space-y-6">
        <!-- 头部说明 -->
        <div
            class="bg-white/90 dark:bg-gray-900/70 tsub-radius-lg p-6 space-y-5 border border-gray-100/80 dark:border-white/10 shadow-sm overflow-hidden">
        ...
        <div v-if="guestbookConfig.enabled"
            class="bg-white dark:bg-gray-800 tsub-radius-lg border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
            <!-- Toolbar -->
            <div
                ...
                <div class="flex items-center gap-2">
                    <select v-model="filterStatus"
                        class="block w-full sm:w-auto pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm tsub-radius-md bg-white dark:bg-gray-700 dark:text-white">
            ...
            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <div v-for="msg in filteredMessages" :key="msg.id"
                    ...
                    <div v-if="msg.reply && replyingId !== msg.id"
                        class="mb-4 ml-4 bg-gray-50 dark:bg-gray-900/50 p-3 tsub-radius-lg border-l-4 border-indigo-500">
                    ...
                    <div v-if="replyingId === msg.id" class="mb-4 ml-4">
                        <textarea v-model="replyContent" rows="3"
                            class="block w-full tsub-radius-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-white dark:bg-gray-700 dark:text-white sm:text-sm"
                            :placeholder="t('settings.guestbookReplyPlaceholder')"></textarea>
                        <div class="mt-2 flex justify-end gap-2">
                            <button @click="cancelReply"
                                class="px-3 py-1.5 text-xs font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 tsub-radius-md">{{ t('actions.cancel') }}</button>
