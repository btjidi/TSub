  ...
  <div>
    ...
    <template v-if="type === 'card'">
      <div
        v-for="i in count"
        :key="i"
        class="bg-white/90 dark:bg-gray-900/80 backdrop-blur-md tsub-radius-lg p-6 card-shadow animate-pulse"
        :style="{ '--delay-index': i - 1 }"
      >
        <div class="flex items-start justify-between mb-4">
          <div class="flex-1">
            <div class="h-4 bg-gradient-to-r from-gray-300 to-gray-200 dark:from-gray-600 dark:to-gray-700 tsub-radius-md w-3/4 mb-2 skeleton-shimmer"></div>
    ...
    <template v-if="type === 'list'">
      <div
        v-for="i in count"
        :key="i"
        class="flex items-center p-4 bg-white/90 dark:bg-gray-900/80 backdrop-blur-md tsub-radius-lg card-shadow animate-pulse mb-3"
        :style="{ '--delay-index': i - 1 }"
      >
    ...
    <template v-if="type === 'dashboard'">
      <div class="space-y-8">
        ...
        <div class="flex justify-between items-center">
          <div class="h-8 bg-gradient-to-r from-gray-300 to-gray-200 dark:from-gray-600 dark:to-gray-700 tsub-radius-md w-48 skeleton-shimmer"></div>
          <div class="flex gap-3">
            <div class="h-10 w-24 bg-gradient-to-r from-gray-300 to-gray-200 dark:from-gray-600 dark:to-gray-700 tsub-radius-md skeleton-shimmer"></div>
            <div class="h-10 w-20 bg-gradient-to-r from-gray-300 to-gray-200 dark:from-gray-600 dark:to-gray-700 tsub-radius-md skeleton-shimmer"></div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div
            ...
            class="bg-white/90 dark:bg-gray-900/80 backdrop-blur-md tsub-radius-lg p-6 card-shadow animate-pulse"
          >
            <div class="h-12 bg-gradient-to-r from-gray-300 to-gray-200 dark:from-gray-600 dark:to-gray-700 tsub-radius-md w-full mb-4 skeleton-shimmer"></div>
        ...
        <div class="space-y-4">
          <div
            v-for="i in 4"
            :key="i"
            class="h-20 bg-white/90 dark:bg-gray-900/80 backdrop-blur-md tsub-radius-lg card-shadow animate-pulse skeleton-shimmer"
          ></div>
        </div>
      </div>
    </template>
