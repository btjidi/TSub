...
<template>
  <button
    ...
    @click="handleClick"
    class="relative inline-flex items-center justify-center rounded-[var(--tsub-radius-md)] font-medium tap-effect disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden group tracking-normal transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-primary-500/30"
    :class="[
      variantClasses,
      sizeClasses
    ]"
