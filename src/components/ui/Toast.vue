  ...
  <div class="fixed z-[100] flex flex-col items-end gap-3 pointer-events-none top-20 md:top-4 right-4 left-4 md:left-auto max-h-[calc(100vh-120px)] md:max-h-[100vh] overflow-hidden pr-1 pb-safe">
    <TransitionGroup name="toast">
      <div
        ...
        :key="toast.id"
        class="toast-container pointer-events-auto w-full sm:w-auto sm:min-w-80 max-w-md backdrop-blur-lg border border-white/20 tsub-radius-lg shadow-2xl overflow-hidden ring-1 transition-all duration-300 relative"
