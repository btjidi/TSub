  ...
  <div ref="containerRef" class="relative group w-full">
    <div class="relative w-full">
      <input
        ...
        class="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 tsub-radius-lg focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-sm transition-all h-[42px] dark:text-white placeholder-gray-400"
        @input="handleInput"
        @focus="handleFocus"
    ...
    <Teleport to="body">
      ...
      >
        <div
          ...
          class="absolute z-[9999] bg-white dark:bg-gray-800 tsub-radius-lg shadow-lg border border-gray-100 dark:border-gray-700 max-h-60 overflow-auto py-1 custom-scrollbar"
          :style="dropdownStyle"
        >
          <button
