    ...
    <template #body>
      <div class="space-y-6">
        ...
        <div class="relative group">
          <div 
            class="relative border tsub-radius-lg transition-all duration-300 overflow-hidden bg-gray-50 dark:bg-black/20 border-gray-200 dark:border-white/10"
            :class="[
              urlFocused 
          ...
          >
            ...
            <div class="flex h-full">
             ...
             <!-- Focus Glow -->
            <div class="absolute inset-0 tsub-radius-lg pointer-events-none transition-opacity duration-300 opacity-0 group-focus-within:opacity-100 ring-1 ring-primary-500/20"></div>
          </div>
        </div>
        ...
        <div v-if="isMultiLine && parsedNodes.length > 0" class="space-y-2">
          ...
          <div class="max-h-48 overflow-y-auto tsub-radius-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
            <div 
