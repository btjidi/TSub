...
<template>
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div>
      ...
      <div class="profile-custom-id-control flex overflow-hidden border border-gray-200 dark:border-white/10 tsub-radius-md focus-within:ring-2 focus-within:ring-primary-500/30 focus-within:border-primary-500/70 dark:focus-within:border-primary-400/60">
        <input
          id="profile-custom-id"
          v-model="localProfile.customId"
          :placeholder="t('profiles.customIdPlaceholder')"
          class="min-w-0 flex-1 bg-white dark:bg-white/[0.035] text-gray-900 dark:text-[#f7f8f8] placeholder-gray-400 dark:placeholder-gray-500 focus:ring-0 focus:border-transparent focus:outline-none transition-colors duration-150 py-2 px-3 text-sm font-mono border-0 rounded-none"
        />
        <button
          type="button"
          data-testid="generate-profile-custom-id"
          class="profile-custom-id-generate inline-flex shrink-0 items-center justify-center rounded-none border-0 border-l border-gray-200 bg-gray-50 px-3 text-xs font-medium text-primary-600 hover:bg-primary-50 disabled:cursor-not-allowed disabled:opacity-40 dark:border-white/10 dark:bg-gray-900 dark:hover:bg-white/10"
  ...
  <div class="bg-gray-50 dark:bg-gray-800/50 tsub-radius-md p-4 border border-gray-100 dark:border-gray-700 mt-4">
    ...
    <div v-if="localProfile.isPublic" class="animate-fade-in-down">
      <textarea
        ...
        class="block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 tsub-radius-md shadow-xs focus:outline-hidden focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:text-white"
      ></textarea>
    </div>
  ...
  <div class="border-t border-gray-200 dark:border-gray-700 pt-4 mt-6">
    ...
    <div v-show="showAdvanced" class="mt-4 space-y-8 animate-fade-in-down">
      ...
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 bg-white dark:bg-gray-800/40 p-4 border border-gray-100 dark:border-gray-700 tsub-radius-lg shadow-sm">
          <!-- 引擎选择 -->
          <div class="space-y-1.5">
            ...
            <select
              ...
              class="block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 tsub-radius-md focus:ring-indigo-500 sm:text-sm dark:text-white transition-all font-medium"
            >
          ...
          <div class="space-y-1.5">
            ...
            <select
              ...
              class="block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 tsub-radius-md focus:ring-indigo-500 sm:text-sm dark:text-white"
            >
          ...
          <div v-if="isExternalEngine" class="sm:col-span-2 animate-fade-in-down border-t border-gray-50 dark:border-gray-700/50 pt-3">
            ...
            <input
              ...
              class="block w-full px-3 py-2 bg-orange-50/20 dark:bg-orange-900/10 border border-orange-200/50 dark:border-orange-500/20 tsub-radius-md sm:text-sm dark:text-white focus:ring-orange-500"
            />
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 bg-white dark:bg-gray-800/40 p-4 border border-gray-100 dark:border-gray-700 tsub-radius-lg shadow-sm">
          ...
          <div>
            ...
            <input
              ...
              class="block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 tsub-radius-md sm:text-sm dark:text-white"
            >
          </div>
          ...
          <div v-if="!isExternalEngine">
            ...
            <select
              ...
              class="block w-full px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 tsub-radius-md sm:text-sm dark:text-white transition-all"
            >
          ...
          <div class="sm:col-span-2 space-y-3 pt-2 border-t border-gray-50 dark:border-gray-700/50">
             ...
             <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="space-y-1">
                    ...
                    <select v-model="localProfile.prefixSettings.enableManualNodes" class="w-full px-2 py-1.5 text-xs bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 tsub-radius-md shadow-xs focus:ring-1 focus:ring-indigo-500">
                ...
                <div class="space-y-1">
                    ...
                    <select v-model="localProfile.prefixSettings.enableSubscriptions" class="w-full px-2 py-1.5 text-xs bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 tsub-radius-md shadow-xs focus:ring-1 focus:ring-indigo-500">
                        <option v-for="option in prefixToggleOptions" :key="String(option.value)" :value="option.value">{{ option.label }}</option>
                    </select>
                </div>
                ...
                <div class="space-y-1">
                    ...
                    <select v-model="localProfile.prefixSettings.prependGroupName" class="w-full px-2 py-1.5 text-xs bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 tsub-radius-md shadow-xs focus:ring-1 focus:ring-indigo-500">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
               <div v-for="flag in flagOptions" :key="flag.key" class="flex flex-col gap-1.5 p-2 bg-gray-50 dark:bg-white/5 rounded-lg border border-gray-100 dark:border-white/5">
                 ...
                 <select v-model="localProfile.subconverter.options[flag.key]"
                   class="w-full px-1.5 py-1 text-[11px] bg-white dark:bg-gray-700 border-none tsub-radius-md focus:ring-1 focus:ring-indigo-500 dark:text-white"
                 >
