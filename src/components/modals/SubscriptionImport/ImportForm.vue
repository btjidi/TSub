...
<template>
  <div>
    ...
    <input
      ...
      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 tsub-radius-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:opacity-50"
