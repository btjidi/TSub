  ...
  <Modal :show="show" @update:show="emit('update:show', $event)">
    ...
    <template #body>
      <div class="flex flex-col items-center gap-6 py-4">
        <div class="bg-white p-4 tsub-radius-lg shadow-inner border border-gray-100 dark:border-gray-700">
          <canvas ref="canvasRef" class="w-64 h-64 tsub-radius-md"></canvas>
        </div>
        ...
        <button
          ...
          class="flex items-center gap-2 px-6 py-2.5 bg-primary-600 hover:bg-primary-700 text-white tsub-radius-lg font-medium transition-colors shadow-lg shadow-primary-500/20 active:scale-95"
        >
