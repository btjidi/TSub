        ...
        <template #title>
            <div class="flex items-center justify-between gap-4">
                ...
                <button @click="closeModal"
                    class="w-10 h-10 flex items-center justify-center tsub-radius-md bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
            ...
            <div v-if="detectedPlatform"
                class="mt-4 flex items-center gap-2 px-3 py-2 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800 tsub-radius-md">
        ...
        <template #body>
            ...
            <div v-else class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
                <button v-for="client in groupedClients" :key="client.id" @click="handleClientClick(client)"
                    class="group relative flex flex-col items-center gap-3 p-4 tsub-radius-lg border-2 transition-all duration-200 hover:scale-105 hover:shadow-lg"
                    ...
                    <div class="w-14 h-14 tsub-radius-lg flex items-center justify-center text-3xl bg-gray-50 dark:bg-gray-800 overflow-hidden"
