...
<template>
  <!-- 订阅名称 -->
  <p v-if="managed" data-testid="managed-subscription-readonly-hint" class="rounded-lg border border-sky-200 bg-sky-50 px-3 py-2 text-xs text-sky-700 dark:border-sky-500/20 dark:bg-sky-500/10 dark:text-sky-300">
    {{ t('subscriptions.managedFieldsReadonly') }}
  </p>
  <div>
    <Input 
      id="sub-edit-name" 
  ...
  <!-- 专属拉取代理 -->
  <div v-if="!managed" class="pt-2 border-t border-gray-100 dark:border-gray-700">
