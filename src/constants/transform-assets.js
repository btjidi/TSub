    ...
    configs: [
        {
            id: 0,
            name: 'TSub 内置 极简默认分流',
            url: 'builtin:clash_tsub_minimal',
            group: 'TSub Builtin',
            is_default: true,
            ...
            description: 'TSub 自带的默认极简模板，适合日常通用、新手用户和优先稳定的场景。'
        },
        {
            id: 1,
            name: 'TSub 内置 ACL4SSR 精简分流',
        ...
        {
            id: 2,
            name: 'TSub 内置 流媒体与 AI 分流',
            url: 'builtin:clash_tsub_media_ai',
            group: 'TSub Builtin',
            is_default: false,
            sourceType: 'builtin-preset',
            recommendedFor: ['clash', 'singbox', 'surge', 'loon', 'quanx'],
