export const NAV_ICONS = {
  ...
  explore: 'M4 12l8-6 8 6v7a2 2 0 01-2 2h-4a2 2 0 01-2-2v-3h-4v3a2 2 0 01-2 2H6a2 2 0 01-2-2v-7z',
  ...
  deployments: 'M17 16h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1zM3 16h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1zM10 2h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zM5 16v-3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3M12 12V8',
...
export const MAIN_NAV_ITEMS = [
  ...
  { key: 'nav.groups', name: '订阅管理', path: '/dashboard/groups', iconPath: NAV_ICONS.groups },
  { key: 'nav.nodes', name: '节点管理', path: '/dashboard/nodes', iconPath: NAV_ICONS.nodes },
  { key: 'nav.subscriptions', name: '我的订阅', path: '/dashboard/subscriptions', iconPath: NAV_ICONS.subscriptions },
  { key: 'nav.deployments', name: '代理部署', path: '/dashboard/deployments', iconPath: NAV_ICONS.deployments },
