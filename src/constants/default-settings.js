...
import { DEFAULT_TRAFFIC_NODE_DISPLAY } from './traffic-node-settings.js';
...
export const DEFAULT_SETTINGS = {
    ...
    dataCommitMode: null,
    cloudflareUsage: {
        enabled: false, accountId: '', apiToken: '', d1DatabaseId: '', kvNamespaceId: '',
        limits: {
...
prependGroupName: false
    ...
    announcement: {
        ...
        content: '为降低 Cloudflare D1 / KV 免费额度超限的风险，本版本已进行一系列优化：<br><br>• 移除服务器探针功能<br>• 内置订阅转换能力，不再依赖第三方转换服务<br>• 优化数据结构与读写逻辑<br>• 降低高频请求场景下的存储与缓存压力<br><br>本次更新主要聚焦于项目的长期稳定运行与免费额度控制。', // 公告内容（支持富文本/Markdown）
