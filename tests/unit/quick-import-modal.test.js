...
describe('QuickImportModal', () => {
  ...
  it('uses mihomo deep link and an explicit Clash target for Clash-Party one-click import', async () => {
    ...
    window.location = { href: 'https://tsub.example/public', origin: 'https://tsub.example' };
    ...
    const expectedUrl = encodeURIComponent('https://tsub.example/profiles/!luckyss?target=clash');
