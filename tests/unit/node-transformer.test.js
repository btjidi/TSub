...
describe('applyNodeTransformPipeline filters', () => {
    ...
    it('removes useless info nodes when useless filter is enabled', () => {
        const vmessTrafficNode = `vmess://${Buffer.from(JSON.stringify({
            v: '2', ps: '↑ 12GB', add: '127.0.0.1', port: '443',
        ...
        const result = applyNodeTransformPipeline([
            ...
            'trojan://00000000-0000-0000-0000-000000000000@127.0.0.1:443#%E2%86%91%2012GB',
            'trojan://00000000-0000-0000-0000-000000000000@127.0.0.1:443#TOT%20100GB',
