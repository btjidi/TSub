...
// KV storage keys
export const KV_KEY_SUBS = 'tsub_subscriptions_v1';
export const KV_KEY_PROFILES = 'tsub_profiles_v1';
export const KV_KEY_GUESTBOOK = 'tsub_guestbook_v1';
...
export const DEFAULT_SETTINGS = {
    ...
    customPage: {
        ...
        hideBranding: false,     // 是否隐藏公开页中的 TSub 品牌标识
