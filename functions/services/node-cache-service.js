    ...
    try {
        ...
        do {
            ...
            for (const keyInfo of keys) {
                ...
                // Active-push and install-snapshot caches are authoritative data, not disposable fetch caches.
                // Their deployment deletion paths remove them explicitly.
                if (preserveKeys.has(key) || key.startsWith('node_cache_subscription_tsub_airport_')) {
                    skipped++;
                    continue;
                }
                try {
