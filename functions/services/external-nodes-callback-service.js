...
const MEMORY_CACHE_SYMBOL = '__tsubExternalNodesCallbackCache';
...
export async function handleExternalNodesCallbackRequest(request, env = {}) {
    ...
    const headers = {
        ...
        'X-TSub-Mode': 'external-nodes-callback'
    };
    if (encoding === 'base64') {
        headers['X-TSub-Callback-Encoding'] = 'base64';
    }
